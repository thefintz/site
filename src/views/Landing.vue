    ...
    <div class="container">
      <div class="columns is-centered is-vcentered pt-5">
        <div class="column">
          ...
          <div>
            <!-- <button @click="sendEvent" class="button px-6 is-medium is-primary has-text-white mr-2">Começar a usar</button> -->
...
import ClientsStories from '../comps/ClientsStories.vue'
import ClientsTestimonies from '../comps/ClientsTestimonies.vue'
...
export default {
  ...
  methods: {
    sendEvent () {
      this.$gtag.event('comecar-click', { event_category: this.$route.name })
      this.$router.push('/comecar-a-usar')
    }
  }
}
</script>
