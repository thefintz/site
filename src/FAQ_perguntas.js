export default [
  {
    question: '<span class="has-text-weight-bold is-size-4"> 1. Por que a Fintz é a melhor opção?</span>',
    answer: 'Diferente de nossos concorrentes, sites aleatório e/ou "webscraping" que tem pelo mercado, nós priorizamos a precisão e a confiabilidade dos nossos dados. Integramos com fontes oficiais e nossos dados passam por rigorosos processos de verificação antes de serem disponibilizados aos nossos clientes. \n\n Além disso, a Fintz possui controle total sobre o pipeline de processamento dos dados, como balanços e resultados, então oferecemos a maior qualidade e agilidade para, por exemplo, adicionar novos dados (ex: indicadores).\n\n Cuidado ao utilizar serviços e APIs que são apenas uma fachada (inclusive não oficial e proibida) do Yahoo Finance, Fundamentus ou similar, pois além de poderem parar de funcionar/atualizar a qualquer momento, geralmente contém erros grotescos em suas informações'
  },
  {
    question: '2. Plano gratuito ou Individual? Posso testar a Fintz antes de comprar?',
    answer: 'Atualmente, essa opção não está disponível. A Fintz destaca-se no mercado por ir além do simples repasse de informações; proporcionamos um sistema completo de integração, padronização, processamento e análise de uma vasta quantidade de dados atuais e históricos.<br><br>Portanto, nosso serviço é inigualável em termos de qualidade, ofertando o melhor produto disponível. No entanto, esse nível superior de qualidade implica custos mais elevados, o que, por ora, nos impede de oferecer tanto o serviço quanto o suporte a um preço reduzido. Somos uma startup em expansão, com uma equipe ainda reduzida, mas, à medida que crescemos, temos a intenção de introduzir mais alternativas de planos.<br><br>No momento só oferecemos um plano: o Enterprise, por R$925/mês, com um compromisso de assinatura de um ano. <br>Para mais informações ou para expressar seu interesse, por favor, entre em contato através do e-mail contato@fintz.com.br.'
  },
  {
    question: '3. O que é a Fintz?',
  ...
  {
    question: '4. Qual a missão da Fintz?',
  ...
  {
    question: '5. Qual problema a Fintz resolve?',
  ...
  {
    question: '6. Quais dados a Fintz oferece?',
  ...
  {
    question: '7. Como posso acessar os dados da Fintz?',
  ...
  {
    question: '8. Quanto custa para acessar os dados da Fintz?',
    answer: 'Consulte os planos e preços atualizados <a href="https://fintz.com.br/#/precos" target="_blank">neste link</a>.'
  },
  {
    question: '9. Os dados da Fintz são atualizados com que frequência?',
  ...
  {
    question: '10. Como integro a API da Fintz em meu sistema ou aplicativo?',
  ...
  {
    question: '11. O que é o plugin Excel/Sheets?',
